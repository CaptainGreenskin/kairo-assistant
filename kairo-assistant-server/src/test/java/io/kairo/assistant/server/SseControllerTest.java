...
class SseControllerTest {
    ...
    void sendRejectsBlankMessage() {
        SseController controller = new SseController(null, TestFixtures.stubGateway(), new SessionAwareDeltaRouter(), new StreamingDeltaRouter());
    ...
    void connectReturnsFlux() {
        SseController controller = new SseController(TestFixtures.defaultSession(), TestFixtures.stubGateway(), new SessionAwareDeltaRouter(), new StreamingDeltaRouter());
    ...
    void sendToUnsubscribedClientReturnsError() {
        ...
        SseController controller = new SseController(session, TestFixtures.stubGateway(), new SessionAwareDeltaRouter(), new StreamingDeltaRouter());
    ...
    private SseController createController() {
        return new SseController(null, TestFixtures.stubGateway(), new SessionAwareDeltaRouter(), new StreamingDeltaRouter());
    }
}
